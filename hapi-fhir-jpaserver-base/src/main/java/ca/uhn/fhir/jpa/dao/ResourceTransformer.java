...
public class ResourceTransformer {
	...
	public static IBaseResource toResource(BaseResourceEntity theEntity) {
		...
		return toResource(type.getImplementingClass(), theEntity, fhirContext);
	}

	public static <T extends IBaseResource> T toResource(Class<T> theResourceType, BaseResourceEntity baseResourceEntity, FhirContext fhirContext) {
		T retVal = null;
		if(baseResourceEntity instanceof BaseHasResource){
			String resourceText = null;
			BaseHasResource theEntity = (BaseHasResource)baseResourceEntity;
			...
			ourLog.error("Parse of resource of type ? is not supported.", baseResourceEntity);
		}
